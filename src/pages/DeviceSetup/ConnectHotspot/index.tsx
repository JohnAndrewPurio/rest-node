  ...
  return (
    <IonRow style={_styles.container}>
      <IonList style={_styles.instructionsList}>
        <IonListHeader>
          <IonLabel style={_styles.instructionsHeader}>
            Steps to connect to your {deviceDetails.type}'s hotspot:{' '}
          </IonLabel>
        </IonListHeader>
        <IonItem lines="none" style={_styles.instructions}>
          ...
          <IonLabel class="ion-text-wrap">
            {' '}
            Go to your phone or tablet's Wi-Fi settings and join your{' '}
            {deviceDetails.type}'s network:{' '}
        ...
        <IonItem lines="none" style={_styles.instructions}>
          ...
          >
            {' '}
            XXXX is the last four digit of your {deviceDetails.type}'s ID
          </IonLabel>
        </IonItem>
        <IonItem lines="none" style={_styles.instructions}>
          <IonIcon
          ...
          <IonLabel
            ...
            style={{ fontSize: '.8rem' }}
          >
            Cannot find the hotspot? Make sure the {deviceDetails.type} is
            switched on
          </IonLabel>
        </IonItem>
        <IonItem lines="none" style={_styles.instructions}>
      ...
      <IonRow style={_styles.bottomPart}>
        <IonButton onClick={connect} fill="outline" style={_styles.nextBtn}>
