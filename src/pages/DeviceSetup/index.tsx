import { IonButton, IonButtons, IonContent, IonGrid, IonHeader, IonPage, IonRow, IonText, IonTitle, IonToolbar, useIonViewDidEnter } from "@ionic/react"
    ...
    const pages = [
        {
            ...
            component: <ChooseDevice nextStep={() => setCurrentStep(1)} setDetails={setNewDeviceDetails} />
        },
        {
            title: "Switch On Device",
            component: <TurnOnDevice nextStep={() => setCurrentStep(2)} setDetails={setNewDeviceDetails} deviceDetails={newDeviceDetails} />
        },
        {
        ...
        <IonPage>
            <IonHeader>
                <IonToolbar>
                    <IonButtons slot="start">
                        <IonButton routerLink={HOME} style={_styles.cancelAdd} fill="clear">Cancel</IonButton>
                    </IonButtons>
            ...
            <IonContent>
                <IonGrid style={_styles.content}>
                    <ProgressBar deviceDetails={newDeviceDetails} pages={pages} currentStep={currentStep} setStep={setStep} />
