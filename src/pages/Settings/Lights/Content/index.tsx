...
const Content: FC = () => {
    ...
    const getState = async () => {
        ...
        const newState = {
            light, brightness, nightLightSchedule, wakeLightSchedule
        };

        lightsState.dispatch(
            setState(newState)
        );
    };
