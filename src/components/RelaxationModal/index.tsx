...
const RelaxationModal: React.FC<Props> = ({
    ...
    if (technique) {
        const audioPlaying =
            state.sample.playing && technique.name === state.sample.audio;

        const audioDownloading = downloadQueue[technique.name];

        const asset = 'Relaxation Sounds';
        const audioDownloaded =
            audioAssets && audioAssets[asset].includes(technique.name); // Temporary hack for searching if audio is already downloaded
                                ...
                                <IonRow>
                                    ...
                                    >
                                        ...
                                        <IonLabel
                                            ...
                                            style={{ fontSize: '1rem' }}
                                        >
                                            Choose this technique for bedtime
                                            relaxation
                                        </IonLabel>
                                    </IonItem>
                                </IonRow>
