    ...
    return (
        <IonPage>
            ...
            <IonContent>
                ...
                <LightControl index={0} title="Night Light" rangeVal={rangeValue[0]} rangeChange={handleRangeChange} onclick={toggleLight} open={lightsOpen[0]} />
                <LightControl index={1} title="Wake Light" rangeVal={rangeValue[1]}  rangeChange={handleRangeChange} onclick={toggleLight} open={lightsOpen[1]} />
            </IonContent>
        </IonPage>
    )
}
...
const LightControl: React.FC<controlProps> = ({ title, index, onclick, open, rangeChange, rangeVal }) => {
    ...
    return (
        <IonRow className={open ? "light-control-container open" : "light-control-container"}>
            ...
            <IonRow style={_styles.rangeContainer}>
                <IonGrid>
                    ...
                    <IonRow>
                        <IonRange onIonChange={(e) => rangeChange(index, e)} value={rangeVal} color="primary" className="range-slider">
