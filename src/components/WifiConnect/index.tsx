...
import {
  postNetworkCredentials,
  wifiCredentialsInterface,
} from '../../api/RestNode/POST/updateNetworkCredentials';
      ...
      <IonGrid>
        <IonRow className="ion-justify-content-center">
          <IonCol className="ion-text-right">
            <IonButton fill="clear" color="warning" onClick={dismissModal}>
              Cancel
            </IonButton>
          </IonCol>
        </IonRow>
