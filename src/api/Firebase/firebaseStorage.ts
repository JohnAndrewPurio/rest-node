import { getDownloadURL, getStorage, ref, list, ListOptions, ListResult } from "firebase/storage";
...
export type getDownloadUrlType = (fileName: string) => Promise<string | undefined>
